...
public class ClockRadio
{
	...
	public void alarmDisabled()
	{
		...
		effectiveAlarmTime = alarmTime;  //cancel soonze: change in effectiveAlarmTime
	}
	...
	{
		return timeToString(getAlarmTimeRaw(), is24HourMode);
	}
	...
	{
		return timeToString(getClockTimeRaw(), is24HourMode);
	}
	...
	{
		return timeToString(getEffectiveAlarmTimeRaw(), is24HourMode);
	}
	...
	public void setAlarmTime(int givenMinutesPastMidnight)
	{
		...
		effectiveAlarmTime = alarmTime;  //cancel snooze: change in effectiveAlarmTime
	}
	...
	{
		//use helper method
		setAlarmTime(amToMinutesRaw(givenHours, givenMinutes, isPm));
	}
	...
	{
		//use helper method
		setTime(amToMinutesRaw(givenHours, givenMinutes, isPm));
	}
